...
import 'e_d_i_titem_detail_page_model.dart';
export 'e_d_i_titem_detail_page_model.dart';

class EDITitemDetailPageWidget extends StatefulWidget {
  const EDITitemDetailPageWidget({
    super.key,
  ...
  static String routeName = 'EDITitemDetailPage';
  static String routePath = '/eDITitemDetailPage';

  @override
  State<EDITitemDetailPageWidget> createState() =>
      _EDITitemDetailPageWidgetState();
}

class _EDITitemDetailPageWidgetState extends State<EDITitemDetailPageWidget> {
  late EDITitemDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EDITitemDetailPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.qty = widget!.initialQty!;
      safeSetState(() {});
      _model.selectedSize = widget!.initialSize;
      safeSetState(() {});
    });
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final eDITitemDetailPageGetProductsResponse = snapshot.data!;
