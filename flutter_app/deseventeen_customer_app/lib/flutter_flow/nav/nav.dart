...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ItemDetailPageWidget(
            productData: params.getParam(
              'productData',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: LogInPageeeWidget.routeName,
          path: LogInPageeeWidget.routePath,
          builder: (context, params) => LogInPageeeWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: OrderHistory2Widget.routeName,
          path: OrderHistory2Widget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => EDITitemDetailPageWidget(
            ...
            initialQty: params.getParam(
              'initialQty',
              ParamType.int,
            ),
            initialSize: params.getParam(
              'initialSize',
              ParamType.String,
            ),
            cartIndex: params.getParam(
              'cartIndex',
              ParamType.int,
            ),
          ),
