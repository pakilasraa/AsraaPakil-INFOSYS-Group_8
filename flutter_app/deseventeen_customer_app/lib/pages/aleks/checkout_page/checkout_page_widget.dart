...
/// theme.
///
/// Top bar: “Checkout”. Show a “Order Summary” card listing items (name,
/// size, quantity, price each and line total). Below, show a totals card with
/// Subtotal, Service / Other Fees placeholder, and Final Total amount. Add a
/// “Delivery or Pickup” selector (two buttons) and basic text fields for
/// Name, Phone, and Notes. At the bottom place a full-width primary button
/// “Place Order”. After a successful order this page will navigate to a
/// confirmation screen or Orders page.
...
class _CheckoutPageWidgetState extends State<CheckoutPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.orderSubtotal =
          functions.sumCartTotals(FFAppState().Cart.toList());
      safeSetState(() {});
      _model.orderTotal = functions.computeOrderTotal(
          _model.orderSubtotal!, _model.deliveryFee!);
      safeSetState(() {});
    });
                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final columnGetCartItemsResponse = snapshot.data!;
                              ...
                              children: [
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.deliveryMethod = 'delivery';
                                      safeSetState(() {});
                                      _model.deliveryFee = 50.0;
                                      safeSetState(() {});
                                      _model.orderTotal =
                                          functions.computeOrderTotal(
                                              _model.orderSubtotal!,
                                              _model.deliveryFee!);
                                      safeSetState(() {});
                                    },
                                    ...
                                    options: FFButtonOptions(
                                      ...
                                      hoverTextColor: Color(0xFFF5F0E6),
                                    ),
                                  ),
                                ),
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.deliveryMethod = 'pickup';
                                      safeSetState(() {});
                                      _model.deliveryFee = 0.0;
                                      safeSetState(() {});
                                      _model.orderTotal =
                                          functions.computeOrderTotal(
                                              _model.orderSubtotal!,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataZ98 = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataZ98 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataZ98 =
